                    ...
                    <div className="row">
                        <div className="col-md-5">
                            <div className="product-gallery-box product-gallery-box--default m-b-60">
                                <div className="product-image--large product-image--large-horizontal">
                                    <img className="img-fluid" id="img-zoom" src="assets/img/product/gallery/gallery-large/product-gallery-large-1.jpg" data-zoom-image="assets/img/product/gallery/gallery-large/product-gallery-large-1.jpg" alt="" />
                                </div>
                                <div id="gallery-zoom" className="product-image--thumb product-image--thumb-horizontal pos-relative">
                                    <a className="zoom-active" data-image="assets/img/product/gallery/gallery-large/product-gallery-large-1.jpg" data-zoom-image="assets/img/product/gallery/gallery-large/product-gallery-large-1.jpg">
                                        <img className="img-fluid" src="assets/img/product/gallery/gallery-large/product-gallery-large-1.jpg" alt="" />
                                    </a>
                                    <a data-image="assets/img/product/gallery/gallery-large/product-gallery-large-2.jpg" data-zoom-image="assets/img/product/gallery/gallery-large/product-gallery-large-2.jpg">
                                        <img className="img-fluid" src="assets/img/product/gallery/gallery-large/product-gallery-large-2.jpg" alt="" />
                                    </a>
                                    <a data-image="assets/img/product/gallery/gallery-large/product-gallery-large-3.jpg" data-zoom-image="assets/img/product/gallery/gallery-large/product-gallery-large-3.jpg">
                                        <img className="img-fluid" src="assets/img/product/gallery/gallery-large/product-gallery-large-3.jpg" alt="" />
                                    </a>
                                    <a data-image="assets/img/product/gallery/gallery-large/product-gallery-large-4.jpg" data-zoom-image="assets/img/product/gallery/gallery-large/product-gallery-large-4.jpg">
                                        <img className="img-fluid" src="assets/img/product/gallery/gallery-large/product-gallery-large-4.jpg" alt="" />
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-7">
                            <div className="product-details-box m-b-60">
                                <h4 className="font--regular m-b-20">Fresh Green Apple</h4>
                                ...
                                <div className="product__price m-t-5">
                                    <span className="product__price product__price--large">$19.00 <del>$29.00</del></span>
                                ...
                                <div className="product-var p-tb-30">
                                    ...
                                    <div className="product-var__item">
                                        <div className="dynmiac_checkout--button">
                                            ...
                                            <label for="buy-now-check" className="m-b-20">I agree with the terms and condition</label>
